...
public class ChunkTypeTypeValueMap<I> extends AbstractTypeValueMap<IChunkType, I> implements ITypeValueMap<IChunkType, I>
{

  private DefaultValueMap<IChunkType,I> _valueMap = new DefaultValueMap<IChunkType,I>();
  ...
  {
    return value instanceof IChunkType;
  }

 
  @Override
  public IChunkType asKeyType(Object value)
  {
    if(value instanceof IChunkType)
      return (IChunkType) value;
    return null;
  }
