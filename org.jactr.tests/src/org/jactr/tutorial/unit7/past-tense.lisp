...
(defun graph-it (data)
  (let ((win (open-exp-window "Irregular Verbs correct" :width 400 :height 300)))
    ...
    (add-line-to-exp-window '(30 10) '(30 260) 'black)
    (add-line-to-exp-window '(380 260) '(30 260) 'black)
    (add-line-to-exp-window '(25 10) '(35 10) 'black)
    (add-line-to-exp-window '(25 60) '(35 60) 'black)
    (add-line-to-exp-window '(25 110) '(35 110) 'black)
    (add-line-to-exp-window '(25 160) '(35 160) 'black)
