 ...
 *
 */
public class UnknownMessageHandler implements MessageHandler<IMessage>
{
  /**
   logger definition
   */
   ...
   */
  public void handleMessage(IoSession arg0, IMessage message) throws Exception
  {
    if (LOGGER.isWarnEnabled()) LOGGER.warn("No clue what to do with debug event "+message+" class:"+message.getClass().getSimpleName());
  }
