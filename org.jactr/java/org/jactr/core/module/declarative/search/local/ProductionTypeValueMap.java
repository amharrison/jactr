...
public class ProductionTypeValueMap<I> extends AbstractTypeValueMap<IProduction, I> implements ITypeValueMap<IProduction, I>
{

  private DefaultValueMap<IProduction,I> _valueMap = new DefaultValueMap<IProduction,I>();
  ...
  {
    return value instanceof IProduction;
  }

 
  @Override
  public IProduction asKeyType(Object value)
  {
    if (value instanceof IProduction)
      return (IProduction) value;
    return null;
  }
