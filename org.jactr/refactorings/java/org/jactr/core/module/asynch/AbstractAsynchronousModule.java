 ...
 * extends {@link #getSetableParameters()}
 * @author harrison
 *
 */
public abstract class AbstractAsynchronousModule extends AbstractModule implements
    IAsynchronousModule, IParameterized
{
  /**
   * Logger definition
   */
  ...
  public BlockingTimedEvent synchronizedTimedEvent(double startTime,
      double blockAtTime)
  {
    BlockingTimedEvent bte = new BlockingTimedEvent(this, startTime, blockAtTime);
