...
public class NullTypeValueMap<I> extends AbstractTypeValueMap<Object,I> implements ITypeValueMap<Object,I>
{
  
  private IValueMap<Object,I> _valueMap;
  
  static final public Object   NULL = new Object();
  
  public NullTypeValueMap()
  {
    _valueMap = new DefaultValueMap<Object,I>();
  }
