...
import org.jactr.core.utils.Commentable;
 ...
 */
public interface IProduction extends Comparable<IProduction>, Commentable
{
   ...
   * this production
   */
  public Collection<IInstantiation> instantiateAll(Collection<Map<String,Object>> provisionalBindings) throws CannotInstantiateException;
