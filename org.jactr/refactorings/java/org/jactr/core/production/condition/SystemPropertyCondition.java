...
{
  static private final transient Log LOGGER = LogFactory.getLog(SystemPropertyCondition.class.getName());
      ...
      IUniqueSlotContainer
  {
    ...
    protected ISlot getPropertyAsSlot(String propertyName)
    {
      ...
      if (LOGGER.isDebugEnabled()) LOGGER.debug("Returning system slot : "+propertyName+" = "+value);
