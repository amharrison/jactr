 ...
 * @author developer
 */
public interface IAuralModule extends IPerceptualModule
{
  ...
  /**
   * return the audicon that is actually responsible for tracking and updating
   * of auditory feature maps
   * 
   * @return
   */
   ...
   * @return
   */
  public Future<IChunk> scanAuditoryField(ChunkTypeRequest request,
   ...
   * @return
   */
  public Future<IChunk> encodeAuditoryChunkAt(IChunk audioEvent,
      double requestTime);
}
