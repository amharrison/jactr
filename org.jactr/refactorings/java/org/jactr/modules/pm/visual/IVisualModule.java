...
public interface IVisualModule extends IPerceptualModule
{
   ...
   * 
   */
  public Future<PerceptualSearchResult> scanVisualField(ChunkTypeRequest chunkPattern, double requestTime,
      boolean isStuffRequest);

  /**
   * 
   */
  public Future<IChunk> encodeVisualChunkAt(PerceptualSearchResult searchResult, double requestTime);
