...
public class ColorChunkCache implements IChunkTypeListener
{
  ...
  final protected void initialize()
  {
    ...
    try
    {
      _colorChunkType = _model.getDeclarativeModule().getChunkType(
          IVisualModule.COLOR_CHUNK_TYPE).get();
  ...
  synchronized public IChunk getColorChunk(Color awtColor)
  {
    ...
    if (chunk == null)
    {
      ...
      try
      {
        chunk = _model.getDeclarativeModule()
            .createChunk(getColorChunkType(), null).get();
